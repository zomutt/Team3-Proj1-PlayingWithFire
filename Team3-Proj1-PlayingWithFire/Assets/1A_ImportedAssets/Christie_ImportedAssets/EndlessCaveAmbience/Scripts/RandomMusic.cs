...
/// <summary>
/// Don't ask me questions about this pls. It was off a prefab. It randomly generates sound to play that loops seamlessly and it's really dang cool.
/// </summary>
public class RandomMusic : MonoBehaviour
{
    ...
    [Range(0, 1)]
    [Tooltip("Overall volume the music fades in to. 1 is full volume.")]
    ...
    [Range(0, 1)]
    [Tooltip("Applies an amount of panning variation to generated sounds. 0 applies no panning changes, 1 allows random panning up to the maximumum extents.")]
    ...
    public void StartMusic()
    {
        if (musicPlaying == false)
        {
            ...
            StartCoroutine(FadeMasterGroup(fadeInDuration, volume));
