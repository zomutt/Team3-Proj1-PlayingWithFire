...
namespace EazyCamera
{
    ...
    public class EazyCam : MonoBehaviour
    {
        ...
        public static EazyCam Instance { get; private set; }
        ...
        // snaps the focal point straight to the target with none of the usual lag/smoothing -- use after a teleport
        // so the camera doesn't spend a few frames sweeping through the level to catch up
